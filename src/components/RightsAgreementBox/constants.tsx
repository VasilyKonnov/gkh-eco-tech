...
Использование отдельных сервисов и/или отдельных функций сервисов Яндекса с применением учетной записи, созданной в упрощенном порядке, может быть недоступно. Для использования функционала сервисов Яндекса в полном объеме Пользователю необходимо выбрать логин и пароль для учетной записи в порядке, установленном п. 2.5.1 Соглашения.
...
2.8.2. Некоторые категории учетных записей Пользователей могут ограничивать или запрещать использование некоторых сервисов Яндекса или их отдельных функций в случае если это предусмотрено при регистрации, либо в условиях использования того или иного сервиса.
